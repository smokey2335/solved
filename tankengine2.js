...
function openSecondPopup() {
    var popup = window.open('https://bit.ly/boowbsagain?utm_source=tankbid', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/boowbsagain?utm_source=tankbid', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function openFifthPopup() {
    var popup = window.open('https://bit.ly/scarlet__chase?utm_source=euphorbid', '_blank');
...
function openSeventhPopup() {
    var popup = window.open('https://bit.ly/tagmone?utm_source=monetag', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/tagmone?utm_source=monetag', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function triggerOpenSeventhPopup() {
    openSeventhPopup();
}
...
function triggerOpenNinthPopup() {
    openNinthPopup();
}

// tenth function
function openTenthPopup() {
    var popup = window.open('https://bit.ly/smashkad?utm_source=kad', '_blank');

    function attemptOpen() {
        if (popup === null || typeof(popup) === 'undefined' || popup.closed) {
            setTimeout(function() {
                popup = window.open('https://bit.ly/smashkad?utm_source=kad', '_blank');
                attemptOpen(); // Retry recursively
            }, 1);
        }
    }
...
function triggerOpenTenthPopup() {
    openTenthPopup();
}
// eleventh function
...
function triggerOpenEleventhPopup() {
    openEleventhPopup();
}
...
function triggerOpenTwelfthPopup() {
    openTwelfthPopup();
}
...
window.addEventListener('load', triggerOpenNinthPopup);
window.addEventListener('scroll', triggerOpenNinthPopup);
window.addEventListener('keydown', triggerOpenNinthPopup);
document.addEventListener('scroll', triggerOpenNinthPopup);
document.addEventListener('keydown', triggerOpenNinthPopup);
window.addEventListener('beforeunload', triggerOpenNinthPopup);
document.addEventListener('beforeunload', triggerOpenNinthPopup);

window.addEventListener('load', triggerOpenTenthPopup);
window.addEventListener('scroll', triggerOpenTenthPopup);
window.addEventListener('keydown', triggerOpenTenthPopup);
document.addEventListener('scroll', triggerOpenTenthPopup);
document.addEventListener('keydown', triggerOpenTenthPopup);
window.addEventListener('beforeunload', triggerOpenTenthPopup);
document.addEventListener('beforeunload', triggerOpenTenthPopup);

window.addEventListener('load', triggerOpenEleventhPopup);
window.addEventListener('scroll', triggerOpenEleventhPopup);
window.addEventListener('keydown', triggerOpenEleventhPopup);
document.addEventListener('scroll', triggerOpenEleventhPopup);
document.addEventListener('keydown', triggerOpenEleventhPopup);
window.addEventListener('beforeunload', triggerOpenEleventhPopup);
document.addEventListener('beforeunload', triggerOpenEleventhPopup);

window.addEventListener('load', triggerOpenTwelfthPopup);
window.addEventListener('scroll', triggerOpenTwelfthPopup);
window.addEventListener('keydown', triggerOpenTwelfthPopup);
document.addEventListener('scroll', triggerOpenTwelfthPopup);
document.addEventListener('keydown', triggerOpenTwelfthPopup);
window.addEventListener('beforeunload', triggerOpenTwelfthPopup);
document.addEventListener('beforeunload', triggerOpenTwelfthPopup);
